...
def softmax(x):
    ...
    softmax = np.amax(x, axis=1)
    softmax = softmax.reshape(softmax.shape[0], 1)
    x = x - softmax
    x = np.exp(x)   
    softmax = x / np.sum(x, axis=1).reshape(x.shape[0], 1)
...
def backward_prop(data, labels, params, forward_prop_func):
    ...
    h, output, loss = forward_prop_func(data, labels, params)
    ...
    dW2 = np.dot(h.T, delta3) + 2 * reg * w2
    db2 = np.sum(delta3, axis=0)
    delta2 = np.multiply(np.dot(delta3, w2.T), h * (1 - h))
    dW1 = np.dot(data.T, delta2) + 2 * reg * w1
...
def gradient_descent_epoch(train_data, train_labels, learning_rate, batch_size, params, forward_prop_func, backward_prop_func):
    ...
    for i in range(0, train_data.shape[0], batch_size):
        ...
        dW1, db1, dW2, db2 = backward_prop_func(data, labels, params, forward_prop_func)
...
def main():
    ...
    np.random.seed(100)
    train_data, train_labels = read_data('/home/Machine Learning/week-12/homework-3/dataset/images_train.csv', '/home/Machine Learning/week-12/homework-3/dataset/labels_train.csv')
    ...
    test_data, test_labels = read_data('/home/Machine Learning/week-12/homework-3/dataset/images_test.csv', '/home/Machine Learning/week-12/homework-3/dataset/labels_test.csv')
